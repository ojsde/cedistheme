{**
 * cedistheme/templates/frontend/components/header.tpl
 *
			...
			<div class="pkp_head_wrapper">
				...
				<div class="pkp_site_name_wrapper">
					...
					{/if}
						...
						{*change elseif clause to closed if*}
						{*{elseif 
						$displayPageHeaderTitle && !$displayPageHeaderLogo && is_string($displayPageHeaderTitle)}
